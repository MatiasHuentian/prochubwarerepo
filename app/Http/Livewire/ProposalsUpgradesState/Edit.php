...
class Edit extends Component
{
    ...
    public function mount(ProposalsUpgradesState $proposalsUpgradesState)
    {
        ...
        $this->mediaCollections = [
            ...
            'proposals_upgrades_state_archivo' => $proposalsUpgradesState->archivo,
            'proposals_upgrades_state_photo'   => $proposalsUpgradesState->photo,
        ];
    }

    public function render()
    {
        return view('livewire.proposals-upgrades-state.edit');
    }
